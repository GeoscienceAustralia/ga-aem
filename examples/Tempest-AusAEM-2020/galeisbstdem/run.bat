...
REM mpiexec -np 4 galeisbstdem-xzcomponents-solve-offsets-and-rxpitch.con	&:: Invert X and Z-components total-field data and solve Dx and Dz Tx-Rx offsets and the Rx pitch
