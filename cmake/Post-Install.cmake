...
if(UNIX)
	if(EXISTS "${CMAKE_INSTALL_PREFIX}/lib/libgatdaem1d.so")
		message(STATUS "Copying shared library libgatdaem1d.so to python/gatdaem1d directory")
		configure_file("${CMAKE_INSTALL_PREFIX}/lib/libgatdaem1d.so" "${CMAKE_INSTALL_PREFIX}/python/gatdaem1d/gatdaem1d.so" COPYONLY)	
		message(STATUS "Copying shared library libgatdaem1d.so to matlab/bin directory")
	...
	if(EXISTS "${CMAKE_INSTALL_PREFIX}/bin/gatdaem1d.dll")
		message(STATUS "Copying shared library gatdaem1d.dll python/gatdaem1d directory")
		configure_file("${CMAKE_INSTALL_PREFIX}/bin/gatdaem1d.dll" "${CMAKE_INSTALL_PREFIX}/python/gatdaem1d/gatdaem1d.dll" COPYONLY)
		message(STATUS "Copying shared library gatdaem1d.dll to matlab/bin directory as gatdaem1d.mexw64")
