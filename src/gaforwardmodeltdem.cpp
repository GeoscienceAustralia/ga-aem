...
{	
	...
	for (size_t i = 0; i < nw; i++)fprintf(fout, "XS[%02lu]%c", i+1, delim);
	for (size_t i = 0; i < nw; i++)fprintf(fout, "YS[%02lu]%c", i+1, delim);
	for (size_t i = 0; i < nw; i++)fprintf(fout, "ZS[%02lu]%c", i+1, delim);
	fprintf(fout, "\n");
	return 0;
}
