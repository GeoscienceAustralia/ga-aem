...
set CFLAGS="-std=c++0x -O3 -DTESTOUTSIDEMATLAB"
set LINK_FFTW="-L/opt/cluster/fftw-3.1.2/lib -lfftw3 -lm"



set OUTDIR="./"
set CMD="icpc  $CFLAGS $INCLUDES $SRCFILES $LINK_FFTW -o $OUTDIR/tdaem1d_shrlib_tester_intel.exe"
echo $CMD
$CMD

set OUTDIR="./"
set CMD="g++ $CFLAGS $INCLUDES $SRCFILES $LINK_FFTW -o $OUTDIR/tdaem1d_shrlib_tester_gnu.exe"
echo $CMD
$CMD
