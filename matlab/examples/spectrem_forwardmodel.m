...
S.stmfile = '..\..\examples\spectrem\stmfiles\Spectrem.stm';
...
G.txrx_dx   = -128;    G.txrx_dy   = 0; G.txrx_dz   = -36;			
G.rx_roll   = 0;       G.rx_pitch  = 0; G.rx_yaw    = 0;

%Setup earth
E.conductivity = [0.05 0.3 0.001];
E.thickness    = [40   20];

%E.conductivity = [0.1 0.4 0.02];
%E.thickness    = [10 20];

%E.conductivity = [0.0001];
%E.thickness    = [];
